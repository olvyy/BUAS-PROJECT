...
public:
	...
	void DrawScaledAnimated(Surface* a_Target, int a_X, int a_Y, int a_Width, int a_Height); //before i could either scale the sprite or have it animated so i had to add this
	...
	unsigned int GetCurrentFrame() const { return m_CurrentFrame; } // to display the frames for debugging
